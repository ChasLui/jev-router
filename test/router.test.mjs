...
test("hasCredentials checks the active provider's variables", () => {
  ...
  delete process.env.CLOUDFLARE_API_TOKEN_JEV;
  delete process.env.CLOUDFLARE_ACCOUNT_ID;
  delete process.env.VERCEL_AI_GATEWAY_API_KEY_JEV;
  ...
  assert.equal(hasCredentials(), true, "TYPESAFE_API_KEY also enables routing");
  delete process.env.TYPESAFE_API_KEY;

  process.env.JEV_PROVIDER = "cloudflare";
  assert.equal(hasCredentials(), false, "token alone is not enough");
  process.env.CLOUDFLARE_API_TOKEN_JEV = "tok";
  ...
  process.env.VERCEL_AI_GATEWAY_API_KEY_JEV = "gk";
  assert.equal(hasCredentials(), true);
  delete process.env.JEV_PROVIDER;
  delete process.env.VERCEL_AI_GATEWAY_API_KEY_JEV;
});
